 ...
 *
 * VERSIÓN DE TRABAJO. Copien este archivo sobre contracts/s14/OraculoConsumidor.sol
 * y corran:  npx hardhat test test/s14/Oraculo.test.js   (6 pruebas).
 *
...
contract OraculoConsumidor {
    ...
    function precioEth(uint256 maxAntiguedad) external view returns (uint256) {
        ...
        // TODO 1 · Si answer <= 0: revert PrecioInvalido();
        // TODO 2 · antiguedad = block.timestamp - updatedAt;
        //          si antiguedad > maxAntiguedad: revert PrecioViejo(antiguedad);
        // TODO 3 · Normalizar a 18 decimales: uint8 d = feed.decimals();
        //          return uint256(answer) * (10 ** (18 - d));
        maxAntiguedad; answer; updatedAt;   // solo para que compile; bórrenla
        return 0;
    }
}
