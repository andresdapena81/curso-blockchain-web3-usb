 ...
 * y volver a votar. ERC20Votes añade ese registro histórico (checkpoints) y la
 * DELEGACIÓN: hay que delegar el voto —a uno mismo o a otro— para que cuente.
 *
 * Material de clase, sin auditar.
 */
contract TokenVoto is ERC20, ERC20Permit, ERC20Votes {
    constructor() ERC20("Token Voto USB", "VOTO") ERC20Permit("Token Voto USB") {}

    function acunar(address a, uint256 cantidad) external {
        _mint(a, cantidad);   // abierto a propósito, para las pruebas del laboratorio
    }
