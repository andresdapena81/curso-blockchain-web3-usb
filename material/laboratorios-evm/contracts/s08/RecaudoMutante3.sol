...
/**
 * @title RecaudoMutante3 · Laboratorio 08 · CON UN ERROR A PROPÓSITO
 ...
 *
 * MUTANTE 3 · tiene exactamente un error. No se dice cuál ni dónde.
 ...
 */
contract RecaudoMutante3 is Ownable {
    enum Estado {
        Activo,
        Exitoso,
        Fallido
