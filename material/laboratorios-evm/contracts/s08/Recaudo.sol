...
/**
 * @title Recaudo con meta y plazo · Laboratorio 08
 ...
 *
 * Este contrato NO trae pruebas en el repositorio: escribirlas es el
 * laboratorio. En la misma carpeta hay tres mutantes, cada uno con un error
 * sutil. Una buena suite pasa contra este archivo y falla contra los tres.
 *
 * Material de clase, sin auditar. Nunca con dinero real.
 */
contract Recaudo is Ownable {
    enum Estado {
        Activo,
        Exitoso,
        Fallido
