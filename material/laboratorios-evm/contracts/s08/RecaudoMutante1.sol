...
/**
 * @title RecaudoMutante1 · Laboratorio 08 · CON UN ERROR A PROPÓSITO
 ...
 *
 * MUTANTE 1 · tiene exactamente un error. No se dice cuál ni dónde.
 ...
 */
contract RecaudoMutante1 is Ownable {
    enum Estado {
        Activo,
        Exitoso,
        Fallido
